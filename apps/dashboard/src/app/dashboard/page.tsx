...
export default function Dashboard() {
  ...
  const sidebarLinks = [
    ...
    { label: "Hive", icon: "M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" },
    { label: "Agents", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" },
    { label: "Memory", icon: "M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 5h10a2 2 0 012 2v10a2 2 0 01-2 2H7a2 2 0 01-2-2V7a2 2 0 012-2z" },
    { label: "Knowledge", icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" },
    { label: "Communication", icon: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" },
    { label: "Workflows", icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" },
    ...
    { label: "Infrastructure", icon: "M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01" },
    ...
    { label: "Settings", icon: "M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35" }
  ];
  ...
  return (
    <div className="min-h-screen bg-[#040404] text-zinc-100 flex flex-col font-sans relative select-none">
      ...
      {/* --- TOP GLOBAL HEADER --- */}
      <header className="h-20 border-b border-zinc-900 bg-[#040404]/80 backdrop-blur-md flex items-center justify-between px-6 z-10 sticky top-0">
        ...
        <div className="hidden lg:flex items-center gap-3 relative max-w-sm w-full mx-6">
          <svg className="w-3.5 h-3.5 text-zinc-500 absolute left-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <input
            ...
            className="w-full pl-10 pr-12 py-2 rounded-lg bg-zinc-950/60 border border-zinc-850 text-xs font-sans text-zinc-300 focus:outline-none focus:border-violet/60 focus:ring-1 focus:ring-violet/30 transition-all placeholder:text-zinc-600"
          />
          <span className="font-mono text-[8px] tracking-widest text-zinc-600 absolute right-4 uppercase bg-zinc-900 px-1.5 py-0.5 rounded border border-zinc-800">
            ⌘ K
          </span>
        </div>

        {/* Center: System Telemetries */}
        <div className="hidden md:flex items-center gap-12 font-mono text-[9px] tracking-widest">
          <div className="flex flex-col">
            <span className="text-zinc-500 uppercase text-[8px]">Intelligence Level</span>
            <span className="text-crimson font-bold text-xs uppercase mt-0.5">OMEGA <span className="text-[10px] text-zinc-400 font-light">9.78</span></span>
          </div>
          <div className="flex flex-col">
            <span className="text-zinc-500 uppercase text-[8px]">Active Agents</span>
            <span className="text-white font-bold text-xs mt-0.5">24,875 <span className="text-[9px] text-green-500 font-medium">+366</span></span>
          </div>
          <div className="flex flex-col">
            <span className="text-zinc-500 uppercase text-[8px]">Hive Time</span>
            <span className="text-zinc-300 font-bold text-xs mt-0.5">{currentTime || "SYNCING..."}</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          {/* Action icon 1 */}
          <button className="w-9 h-9 rounded-lg border border-zinc-850 bg-zinc-950/40 flex items-center justify-center text-zinc-400 hover:text-white hover:border-violet/40 transition-colors">
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M4 8h16" />
            </svg>
          </button>
          
          {/* Action icon 2 (Notification with bubble) */}
          <button className="w-9 h-9 rounded-lg border border-zinc-850 bg-zinc-950/40 flex items-center justify-center text-zinc-400 hover:text-white hover:border-violet/40 relative transition-colors">
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <span className="absolute -top-1.5 -right-1.5 w-4 h-4 rounded-full bg-crimson border border-[#040404] text-[7.5px] font-bold text-white flex items-center justify-center">
              12
            </span>
          </button>

          {/* User profile dropdown link */}
          <a href="/profile" className="flex items-center gap-3 pl-3 pr-4 py-1.5 rounded-lg border border-zinc-850 bg-zinc-950/30 hover:border-violet/30 transition-all">
            <div className="w-7 h-7 rounded-full bg-gradient-to-tr from-crimson to-violet p-[1.5px]">
              <div className="w-full h-full rounded-full bg-[#09070A] flex items-center justify-center text-[10px] font-mono text-zinc-400">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* ==================== LEFT SIDEBAR ==================== */}
        <aside className="w-56 border-r border-zinc-900 bg-[#040404] flex flex-col justify-between p-4 hidden md:flex shrink-0">
            ...
            {sidebarLinks.map((link) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-lg font-sans text-[10px] font-bold tracking-[0.2em] uppercase transition-all duration-300 relative group ${
                    isActive 
          ...
          {/* Bottom Rotating Globe Widget */}
          <div className="p-4 rounded-xl border border-zinc-900 bg-zinc-950/40 flex flex-col items-center text-center">
            {/* Spinning vector globe */}
            <div className="w-16 h-16 rounded-full border border-violet/20 flex items-center justify-center relative mb-4 overflow-hidden">
              <div className="absolute inset-2 rounded-full border border-dashed border-violet/30 animate-[spin_10s_linear_infinite]"></div>
              <div className="absolute inset-0 bg-radial-gradient(from_center,rgba(0,229,255,0.1)_0%,transparent_60%)"></div>
              {/* Pulsing core dot */}
              <span className="w-2.5 h-2.5 rounded-full bg-cyan shadow-[0_0_12px_#00E5FF] animate-pulse"></span>
            </div>

            <span className="block font-mono text-[8px] tracking-[0.2em] text-zinc-500 uppercase">HIVE STATUS</span>
            <span className="block font-sans text-xs font-bold text-green-500 uppercase tracking-widest mt-1">THRIVING</span>
            <span className="block font-mono text-[7px] text-zinc-600 mt-1 uppercase">All systems optimal</span>
          </div>
        </aside>
